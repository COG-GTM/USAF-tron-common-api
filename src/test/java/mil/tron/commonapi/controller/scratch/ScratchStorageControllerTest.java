...
public class ScratchStorageControllerTest {
    ...
    void testGetAllByAppId() throws Exception {
        ...
        Mockito.when(service.userCanReadFromAppId(Mockito.any(UUID.class), Mockito.anyString(), Mockito.anyString()))
    ...
    void testDeleteAllByAppId() throws Exception {
        ...
        Mockito.when(service.userCanDeleteKeyForAppId(Mockito.any(UUID.class), Mockito.anyString(), Mockito.anyString()))
                .thenReturn(true); // let user have the privs to mutate
